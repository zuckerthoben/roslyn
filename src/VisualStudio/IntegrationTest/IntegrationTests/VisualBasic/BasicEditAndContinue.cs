...
namespace Roslyn.VisualStudio.IntegrationTests.VisualBasic
{
    ...
    public class BasicEditAndContinue : AbstractEditorTest
    {
        ...
        public BasicEditAndContinue( ) : base()
        {
        ...
        [TestMethod, Ignore("https://github.com/dotnet/roslyn/issues/21925")]
...
");
            ...
            VisualStudioInstance.ActivateMainWindow(skipAttachingThreads: true);
            VisualStudioInstance.SolutionExplorer.OpenFile(project, module1FileName);
            ...
            VisualStudioInstance.Dialog.VerifyOpen(microsoftVisualStudioDialogName);
            VisualStudioInstance.Dialog.Click(microsoftVisualStudioDialogName, "OK");
            VisualStudioInstance.Dialog.VerifyClosed(microsoftVisualStudioDialogName);
            VisualStudioInstance.Editor.Verify.IsProjectItemDirty(expectedValue: false);
        }

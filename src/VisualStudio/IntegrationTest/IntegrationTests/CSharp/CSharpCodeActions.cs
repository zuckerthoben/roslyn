...
namespace Roslyn.VisualStudio.IntegrationTests.CSharp
{
    ...
    public class CSharpCodeActions : AbstractEditorTest
    {
        ...
        [TestMethod, Ignore("https://github.com/dotnet/roslyn/issues/26204"), TestCategory(Traits.Features.CodeActionsGenerateMethod)]
...
");
        ...
        [TestMethod, TestCategory(Traits.Features.CodeActionsAddImport)]
...
class Program
{
    static void Main(string[] args)
    {
        ...
        [TestMethod, TestCategory(Traits.Features.CodeActionsInvokeDelegateWithConditionalAccess)]
...
class C
{
    ...
    void RaiseSecond()
    {
        ...
        [TestMethod, Ignore("https://github.com/dotnet/roslyn/issues/30015")]
        [TestCategory(Traits.Features.EditorConfig)]
        [TestCategory(Traits.Features.CodeActionsFixAllOccurrences)]
...
class C
{
    ...
    public int Y2
    {
        ...
        [TestMethod, TestCategory(Traits.Features.CodeActionsGenerateMethod)]
...
namespace NS
{
    public class P2
    {
        ...
        [TestMethod, TestCategory(Traits.Features.CodeGeneration)]

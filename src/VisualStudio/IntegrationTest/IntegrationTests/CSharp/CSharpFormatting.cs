...
namespace Roslyn.VisualStudio.IntegrationTests.CSharp
{
    ...
    public class CSharpFormatting : AbstractEditorTest
    {
        ...
        [TestMethod, TestCategory(Traits.Features.Formatting)]
...
class Program
{
    static void Main()
    {
        ...
        [TestMethod, Ignore("https://github.com/dotnet/roslyn/issues/18065"),
         TestCategory(Traits.Features.Formatting)]
